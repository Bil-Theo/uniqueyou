...
<body>
	...
	<h3 class="theme" style="margin-left: 43%; margin-top: 0%">Commandes Finalisées</h3>
    <table class="table table-striped">
        ...
        <%
			 ...
			 String mdps =  "root";
			 String query = "SELECT C.id, C.libelle, C.statut, C.decision, C.quantite, C1.nom, C2.nom, C1.email, C2.email, C1.pays, C2.pays, C1.telephone, C2.telephone from commande C, compte C1, compte C2 WHERE C1._id != C2._id AND C1._id = C.id_user AND C2._id = C.id_client AND statut ='Finale' AND C.id_user = ? GROUP BY C.id, C2._id, C1._id ORDER BY date ASC";
        ...
        %>
            ...
            <tr>
                ...
                <td>Finalisée</td>
                <td>
                	<%if(result.getInt("C.decision")==1){ %>
                	<p style="color: green">Acceptée</p>
                	<%}else{ %>
                	<p style="color: red">Réfusée</p>
                	<%} %>
                </td>
