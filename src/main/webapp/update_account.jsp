...
<body >
	...
	<div style="margin-left: 5%; margin-top: 1%">
		<a href="delete_account?id_current=<%=user._id %>" id ="lien" style="color: red; font-size: 17px" class="suppr">Supprimer mon compte</a>
	</div>
	<%}
	String[] Afrique = {
		    "Afrique du Sud",
	...
	monLien.addEventListener("click", function(event) {
	    // Empêcher le comportement par défaut du lien (par exemple, la navigation)
	    event.preventDefault();

	    // Afficher la boîte de dialogue de confirmation
	    var confirmation = window.confirm("Voulez-vous vraiment supprimer votre compte ?");

	    // Si l'utilisateur clique sur "OK", suivre le lien
	    if (confirmation) {
	        // Récupérer l'URL du lien
	        var url = monLien.getAttribute("href");
