		            ...
		            <div class="col-md-4">
		                <div class="card custom-card">
		                    ...
		                    <div class="card-body">
		                        ...
		                        <a style='background-color: #10D4FF; border-color: #10D4FF; margin-left: 6%;' href="details.jsp?id_current=<%= result.getInt("_id") %>" class="btn btn-primary">Détails</a>
		                    ...
		                    <div class="card-body">
		                        ...
		                        <a style='background-color: #10D4FF; margin-left: 6%; border-color: #10D4FF;' href="details.jsp?id_current=<%= result.getInt("_id") %>" class="btn btn-primary">Détails</a>
		                        <a href="j_achat_item?id_current=<%= result.getInt("_id") %>" style='background-color: #08D140; border-color: #08D140; margin-left: 20%;' class="btn btn-success">Ajouter</a>
		                    </div>
