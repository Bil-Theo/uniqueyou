...
<body>
	<header>
		<nav style='margin-left: 10%; margin-right: 10%;'>
			...
			<div class='option'>
				...
				<a href="details.jsp" class='lien' style='margin-left: 80%; padding-left: 30%;'>
    ...
    <%} %>
		<div style="margin-top: 3%; margin-left: -35%;">
			<a href='#' class='lien' style='margin-left: -1%; margin-bottom: 1%;'>
		            ...
		            <div class="col-md-4">
		                <div class="card custom-card">
		                    ...
		                    <div class="card-body">
		                        ...
		                        <a style='background-color: #10D4FF; border-color: #10D4FF;' href="update_item.jsp?id_current=<%= result.getInt("_id") %>" class="btn btn-primary">Modifier</a>
